...
while True:
    ...
    for k,v in article_Dict.items():
        ...
        current_time=f'{now.day}/{now.month}/{now.year}%{now.hour}:{minute}'

        if stock:
            output='\033[0;37;40m '+current_time+'*\033[1;32;40m ***DISPONÍVEL*** \033[0;37;40m *'+k+'@'+price
        else:
            output=current_time+'\033[1;31;40m &&&NÃO-DISPONÍVEL&&& \033[0;37;40m'+k+'@'+price
